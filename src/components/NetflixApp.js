...
const NetflixApp = () => {
    ...
    <div>
        <div>
            <img src="images/netflix-logo.png" alt="Logo Netflix" height="20" />
            <a href="/">Accueil</a>
            <a href="/">Séries</a>
            <a href="/">Films</a>
            <a href="/">Nouveautés</a>
            <a href="/">Ma liste</a>
            <img src="images/netflix-avatar.png" alt="avatar" height="20" />
        </div>
        <header>
            <div>
                ...
                <h1>Le Professeur recrute une jeune braqueuse et sept autres criminels
